...
switch inertiaW1CS
    ...
    case 5 % adaptive based on velocity (abv) -----------------------------
        % disp("w1 ==> adaptive based on velocity (abv)")
        popSize = pop.size(it);
    ...
    case 6 % double exponential self-adaptive (desa) ----------------------
        % disp("w1 ==> double exponential self-adaptive (desa)")
